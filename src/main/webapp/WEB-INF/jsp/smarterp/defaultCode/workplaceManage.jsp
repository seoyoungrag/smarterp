					...
					<div id="kt_header" class="kt-header kt-grid__item " data-ktheader-minimize="on">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-subheader   kt-grid__item">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">사업장목록</h3>
						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="companyManageContent">
							<div class="kt-subheader kt-grid__item" id="kt_subheader">
								<div class="kt-container  kt-container--fluid ">
									<div class="kt-subheader__main">
										<h3 class="kt-subheader__title">사업장코드관리</h3>
									</div>
							...
							<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
								...
								<div class="row">
									<div class="col-xs-4 col-sm-4 col-md-4" id="listDetail">
										<jsp:include page="/WEB-INF/jsp/smarterp/defaultCode/workplaceManage/listDetail.jsp" flush="true" />
									</div>
									<div class="col-xs-8 col-sm-8 col-md-8" id="cruDetail">
										<jsp:include page="/WEB-INF/jsp/smarterp/defaultCode/workplaceManage/cruDetail.jsp" flush="true" />
									</div>
								</div>  
							</div><!--end::Portlet--> 
						</div><!-- end:: Content -->
